...
version = None
with open(os.path.join(os.getcwd(), "jupyterlab_vizier",
                       "version.py")) as f:
  for l in f:
...
npm_package = "jupyterlab_vizier-{}.tgz".format(version)
...
data_files = [
    ...
    ("etc/jupyter/jupyter_notebook_config.d",
     ("jupyter-config/jupyter_notebook_config.d/jupyterlab_vizier.json",
     )),
]

setup(
    name="jupyterlab_vizier",
    version=version,
    description="oogle Cloud Platform AI Vizier Jupyter Extension",
