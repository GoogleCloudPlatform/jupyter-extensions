    ...
    >
      ...
      <Box my={2} px={1}>
        <Typography variant="body2">
          AI Platform Vizier is a black-box optimization service that helps you
          tune hyperparameters in complex machine learning (ML) models through
          studies.{' '}
          <Link
...
export class SidebarWidget extends ReactWidget {
  constructor(private readonly reduxStore: Store) {
    super();
    this.id = 'vizier-sidebar';
    this.title.iconClass =
      'jp-Icon jp-Icon-20 jp-vizier-icon jp-vizier-icon-rotate';
    this.title.caption = 'GCP Vizier';
  }
