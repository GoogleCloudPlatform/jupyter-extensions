...
version = None
with open(os.path.join(os.getcwd(), "jupyterlab_caip_optimizer",
                       "version.py")) as f:
  for l in f:
...
npm_package = "jupyterlab_caip_optimizer-{}.tgz".format(version)
...
data_files = [
    ...
    ("etc/jupyter/jupyter_notebook_config.d",
     ("jupyter-config/jupyter_notebook_config.d/jupyterlab_caip_optimizer.json",
     )),
]
...
setup(
    ...
    version=version,
    description="oogle Cloud Platform AI Optimizer Jupyter Extension",
