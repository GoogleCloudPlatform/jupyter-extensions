...
class TestNotebookInit(unittest.TestCase):
  ...
  def test_add_file_cache(self):
    ...
    self.assertTrue(
        file_exists,
        msg="directory in '.sync_cache' containing cached files does not exist")
  ...
  def test_init_cache_files(self):
    ...
    self.assertTrue(b'base.ipynb' in cache_file_list,
                    msg="'base.ipynb' was not created")
    self.assertTrue(b'local.ipynb' in cache_file_list,
                    msg="'local.ipynb' was not created")
    self.assertTrue(b'remote.ipynb' in cache_file_list,
                    msg="'remote.ipynb' was not created")
    self.assertTrue(b'merged.ipynb' in cache_file_list,
                    msg="'merged.ipynb' was not created")
